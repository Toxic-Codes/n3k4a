...
W='\033[0m'
# The Credit For This Code Goes To SpeedX And All Other Contributors Listed At https://github.com/Toxic-Codes/n3k4a
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update n3k4a')
        ...
        print("              This Bomber Was Created By n3k4a !!                ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/Toxic-Codes/n3k4a/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/Toxic-Codes/n3k4a/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/Toxic-Codes/n3k4a/master/.notify").read().decode('utf-8')
...
if nm == 0:
    ...
    print("     Please keep your data connection active during n3k4a !!    ")
    print("==================================================================")
