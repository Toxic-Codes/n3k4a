...
W='\033[0m'
# The Credit For This Code Goes To n3k4a And All Other Contributors Listed At https://github.com/Toxic-Codes/n3k4a
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo n3k4a >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    n3k4as = int(counter) + 1
    while success < (int(n3k4as)):
        os.system('clear')
        banner()
        try:
            api = random.choice(ch)
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update Tn3k4a')
                input('Press Enter To Exit...')
                exit()
            else:
                if success > 0:
                    print(
                        '\n\n\tWe Are Sorry To Say That n3k4aing Limit For Your Country Has Been Reached...')
                    print(
                    ...
                    print(
                        '\t\tPlease Send A Mail To ggn3k4a29@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print(random.choice(colors))
        print("==================================================================")
        print("                n3k4aING in progress, please wait !!               ")
        print("     Please keep your data connection active during n3k4aing !!    ")
        print("==================================================================")
        ...
        print("              This N3K4A Was Created By n3k4a !!                ")
        print("==================================================================")
        try:
...
def update():
    stuff_to_update = ['N3K4A.py', '.version']
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://github.com/Toxic-Codes/n3k4a/master/.version" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://github.com/Toxic-Codes/n3k4a/master/.notify").read().decode('utf-8')
verl = ''
try:
...
if not cc.strip() == "91":
    if type == 1:
        print(
            '\t\tSorry But Call n3k4aing is Currently Supported Only For Indian Numbers!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
...
if pn.strip() == '' or dl <= 0 or nm < 0:
    ...
    exit()
if type == 1:
    print("NOTE: Call n3k4a Might Not Work on DND Activated Numbers...\n")
    print("\n\tPlease Don't Overload Call n3k4a So That Is Would Work For Longer Period Of Time...")
    cn3k4a = True
if cn3k4a:
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tTn3k4a Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
    print("\n\nPlease Remember That This Is in Experimental Stage And Is Incredibly Fast...")
    t = [None] * nt
    print(random.choice(colors))
    print("\n\n==================================================================")
    print("                Gearing Up N3K4A, please wait !!               ")
    print("     Please keep your data connection active during n3k4aing !!    ")
    print("==================================================================")
    ...
    print("==================================================================")
    print(W)
    input('\n\nPress CTRL+Z To STOP N3K4A... \nPress Enter To Start N3K4A...\n')
    os.system('rm *.xxx* > /dev/null 2>&1')
    print("\n\nStarting n3k4a....")
    for i in range(nt):
